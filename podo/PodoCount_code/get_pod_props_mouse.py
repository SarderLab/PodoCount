...
#Functions
def get_pod_props_mouse(roi,glom_mask,slider,x_start,y_start,xml_counter,xml_contour,count,dist_mpp,area_mpp2, ihc_gauss_sd, dt_gauss_sd, max_major, min_minor, max_ecc, emt_thresh):
    #Parameters
    #ihc_gauss_sd = 2
    #dt_gauss_sd = 1
    min_area = 120
