...
def get_pod_props_mouse(roi,glom_mask,slider,x_start,y_start,xml_counter,xml_contour, gcount, pcount,dist_mpp,area_mpp2, section_thickness, ihc_gauss_sd, dt_gauss_sd, emt_thresh):
    #Parameters
    #ihc_gauss_sd = 2
    #dt_gauss_sd = 1
    min_area = 120
    ...
    nuclei_label, num_labels = sp.ndimage.label(nuclei - nuclei_dt_max)
    ...
    if np.sum(nuc_euls)>0:
        ...
        separated_podocytes[nuclei==1]=1

    else:
        separated_podocytes = nuclei
